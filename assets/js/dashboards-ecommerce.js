...
! function() {
    ...
    c = isDarkStyle ? (o = config.colors_dark.cardColor, e = config.colors_dark.headingColor, r = config.colors_dark.axisColor, s = config.colors_dark.borderColor, t = "dark", a = "#4f51c0", i = "#595cd9", n = "#8789ff", "#c3c4ff") : (o = config.colors.white, e = config.colors.headingColor, r = config.colors.axisColor, s = config.colors.borderColor, t = "", a = "#e1e2ff", i = "#c3c4ff", n = "#a5a7ff", "#696cff");
    ...
    l = document.querySelector("#activityChart"), d = {
        chart: {
            height: 120,
            width: 220,
            parentHeightOffset: 0,
    ...
    l = document.querySelector("#profitChart"), d = {
        series: [{
            data: [58, 28, 50, 80]
        }, {
            data: [50, 22, 65, 72]
    ...
    l = document.querySelector("#expensesChart"), d = {
        chart: {
            height: 130,
            sparkline: {
                enabled: !0
    ...
    l = document.querySelector("#totalIncomeChart"), d = {
        chart: {
            height: 250,
            type: "area",
            toolbar: !1,
    ...
    l = document.querySelector("#performanceChart"), d = {
        series: [{
            name: "Income",
    ...
    l = document.querySelector("#conversionRateChart"), d = {
        chart: {
            height: 80,
            width: 140,
            type: "line",
    ...
    l = document.querySelector("#expensesBarChart"), d = {
        series: [{
            name: "2021",
    ...
    l = document.querySelector("#totalBalanceChart"), d = {
        series: [{
