...
$alldata=API::FetchData($api["api_code"],$temp_payload,array($api["api_db_key"]=>$temp_payload));
/*
$alldata=json_decode('{
    "success": true,
...
*/
$alldata=Functions::flattenArray($alldata);
?>
    ...
    <tbody>
        <?php if($alldata){ ?>
            <?php foreach($alldata as $key=>$val){ ?>
                <tr>
                    <td><?php echo Functions::transformRow($key); ?><input type="hidden" name="rowFields[]" value="<?php echo Functions::transformRow($key); ?>"></td>
                    <td><?php echo Functions::transformRow($val); ?><input type="hidden" name="rowValues[]" value="<?php echo Functions::transformRow($val); ?>"></td>
                </tr>
            <?php } ?>
        <?php } ?>
    </tbody>
